...
<div class="container">
    <H1> Modifier une oeuvre : ${monOeuvre.idOeuvrevente} </H1>
    <form name='identification' method="post" action="ControleurOeuvres?action=modifierOeuvre&idOeuvre=${monOeuvre.idOeuvrevente}">
        ...
        <div class="form-group">
            <input type="submit" name="bt" value="Modifier" class="form-control">
        </div>
    </form>
</div>
